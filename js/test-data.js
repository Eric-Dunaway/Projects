...
var gCatherInTheRye = new Book({title:"Catcher In The Rye", author:"JD Salinger", numberOfPages:200,publishDate:"December 25, 1987"});

var Neuromancer_Gibson =   new Book({title: "Neuromancer",author: "William Gibson",numberOfPages: 0,publishDate: "1/1/1984"});
...
console.table($lib.books)
console.log('Add a different Book gCatherInTheRye: ' + $lib.addBook(gCatherInTheRye))
console.table($lib.books)
console.groupEnd();
...
console.table($lib.books);
console.groupEnd();
console.log('Remove Stephenson Books: ' + $lib.removeBookByAuthor('Neal Stephenson'))
console.table($lib.books);
console.groupEnd();

console.groupCollapsed('Add Books');
$lib.removeBookByAuthor('Neal Stephenson')
$lib.removeBookByAuthor('Roger Zelazny')
$lib.removeBookByAuthor('William Gibson')
console.groupCollapsed('Starting Value');
console.table($lib.books);
console.groupEnd();
...
$lib.removeBookByAuthor('Stephen King');
}
